    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
      ...
      <div class="bg-gray-50 p-4 rounded shadow text-center">
        <h3 class="text-sm text-gray-500">
          <i class="pi pi-users"></i> Total Users
        </h3>
      ...
      <div class="bg-gray-50 p-4 rounded shadow text-center">
        <h3 class="text-sm text-gray-500">
          <i class="pi pi-building"></i> Total Organizations
        </h3>
      ...
      <div class="bg-gray-50 p-4 rounded shadow text-center">
        <h3 class="text-sm text-gray-500">
          <i class="pi pi-server"></i> CPU Usage
        </h3>
      ...
      <div class="bg-gray-50 p-4 rounded shadow text-center">
        <h3 class="text-sm text-gray-500">
          <i class="pi pi-box"></i> Memory Usage
        </h3>
        <p class="text-2xl font-bold text-gray-800">{{}}%</p>
      </div>
      ...
      <div class="bg-gray-50 p-4 rounded shadow text-center">
        <h3 class="text-sm text-gray-500">
          <i class="pi pi-briefcase"></i> Active Projects
        </h3>
        <p class="text-2xl font-bold text-gray-800">
      ...
      <div class="bg-gray-50 p-4 rounded shadow text-center">
        <h3 class="text-sm text-gray-500">
          <i class="pi pi-history"></i> Activity Log
        </h3>
