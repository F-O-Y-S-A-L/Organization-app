<template>
  <div class="min-h-screen bg-[#070b12] font-sans relative overflow-x-hidden">
    ...
    <div class="relative z-10 max-w-[1200px] mx-auto px-4 md:px-8 py-10 pb-20">
      <!-- Header -->
      <div class="flex items-center gap-4 mb-10">
        ...
        <div>
          ...
          <p class="text-sm text-gray-500 mt-0.5">
            Your collaborative spaces and teams
          </p>
        </div>
      </div>
        ...
        <div class="flex flex-col md:flex-row md:items-center gap-4 relative">
          <div class="flex-1">
            ...
            <p class="text-gray-400 text-sm mt-1 max-w-md">
              A collaborative space where team members manage organizations and
              track progress.
            </p>
          </div>
          <!-- Stat pill -->
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        <div
          v-for="(org, index) in orgStore.organization"
          :key="org._id"
        ...
        >
          ...
          <div class="p-5 pb-4">
            <div class="flex items-start gap-3 mb-4">
              ...
              <div class="min-w-0">
                <h3
                  class="font-bold text-gray-100 text-base leading-tight truncate group-hover:text-indigo-300 transition-colors"
                >
                  {{ org.name }}
                </h3>
                <p
                  class="text-[11px] text-gray-600 mt-0.5 flex items-center gap-1"
                >
